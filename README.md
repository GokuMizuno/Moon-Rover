...
Test suite used was catch2
Tests in /tests folder.

GUI initially used was wxWidgets, but the ld linker decided it didn't like me, and stopped reading it.
I added a TUI, for partial credit.
I did not upload the GUI aspect, as I couldn't test that, but I will upload if requested.
